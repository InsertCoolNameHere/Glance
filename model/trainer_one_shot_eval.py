...
class HierarchicalSRTrainer(pl.LightningModule):
    ...
    def __init__(self, opt=None, base_dir="/nopath", save_dir="data/checkpoints", num_nodes=1, current_scale=0, isret = False):
        ...
        self.train_cnt = 0.0
        self.train_l1 = 0.0
        logging.info("RIKI: BEGINNING EPOCH: "+str(self.start_epoch)+" "+str(self.current_scale_id))
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        logging.info('RIKI: EPOCH %d PSNRS: %f VALIDATION LOSSES: %s %s' % (self.current_epoch, avg_psnr, str(avg_losses), str(avg_l1)))
        '''self.psnrs = 0.0
        self.losses = 0.0
        self.losses_l1 = 0.0
        self.psnr_count = 0.0'''
